...
const icons = [
  (
    <svg key={1} fill="currentColor" width={20} height={20} viewBox="0 0 24 24" aria-hidden="true">
      <g>
  ...
  (
    <svg key={2} fill="currentColor" width={20} height={20} viewBox="0 0 24 24" aria-hidden="true">
      <g>
  ...
  (
    <svg key={3} fill="currentColor" width={20} height={20} viewBox="0 0 24 24" aria-hidden="true">
      <g>
  ...
  (
    <svg key={4} fill="currentColor" width={20} height={20} viewBox="0 0 24 24" aria-hidden="true">
      <g>
  ...
  (
    <svg key={5} fill="currentColor" width={20} height={20} viewBox="0 0 24 24" aria-hidden="true">
      <g>
  ...
  (
    <svg key={6} fill="currentColor" width={20} height={20} viewBox="0 0 24 24" aria-hidden="true">
      <g>
