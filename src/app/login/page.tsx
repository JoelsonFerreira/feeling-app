  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-[rgba(91,_112,_131,_0.4)]">
      <form className="bg-black flex flex-col items-center gap-6 px-20 py-8 rounded-2xl" action={loginUser}>
        ...
        <h1 className="w-full text-3xl font-bold">Entrar no X</h1>
        <Input placeholder="Nome de usuário" name="name" />
        <Input placeholder="********" type="password" name="password" />

        <SubmitButton className="w-full">Avançar</SubmitButton>

        <span className="text-[rgb(113,118,123)] text-sm">Não tem uma conta? <Link href="/register" className="text-[rgb(29,155,240)] hover:underline">Inscreva-se</Link></span>
      </form>
    </div>
  )
}